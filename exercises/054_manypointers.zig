...
//   +---------------+----------------------------------------------+
//
// A slice is a pointer with a length
// A manyptr is a traditional C pointer where we can treat it like an array, but we don't know the length of the array
//  This is how we have to do var length strings...
